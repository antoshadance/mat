...
<svg height={props.h} width={props.w} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.955 31.955">
	<g>
		<path fill={props.color} d="M27.25,4.655C20.996-1.571,10.88-1.546,4.656,4.706C-1.571,10.96-1.548,21.076,4.705,27.3
			c6.256,6.226,16.374,6.203,22.597-0.051C33.526,20.995,33.505,10.878,27.25,4.655z"/>
		<path fill={props.color}  d="M13.288,23.896l-1.768,5.207c2.567,0.829,5.331,0.886,7.926,0.17l-0.665-5.416
		...
		<circle fill={props.color} cx="15.979" cy="15.977" r="6.117"/>
	</g>
</svg>
     );
}
